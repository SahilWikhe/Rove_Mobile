...
Hosted evidence: migration 0060 passed the isolated Neon rehearsal through the restricted pooled role. Twelve concurrent synthetic quote requests yielded exactly ten successful consumes and two RATE_LIMITED responses; unscoped counter reads returned no rows. Provider-staging rollout remains pending.
