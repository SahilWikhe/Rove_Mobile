...
The subsequent durable checkpoint below adds observations, webhook/recovery orchestration and owned receipt presentation. Subsequent checkpoints add staff authorization and processor balance journals; commercial loss allocation remains unresolved.

## Durable refund tracking

The provider history boundary is now consumed by the flagged durable worker and rider receipt path. See [refund tracking](66-refund-tracking.md) for migration, recovery and rollout. Later checkpoints add refund authorization and processor balance journals. Commercial loss allocation, disputes and transfers remain unfinished.
