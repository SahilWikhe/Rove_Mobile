...
Next financial work: durable staff-authorized refund operations with cumulative limits and retry recovery, balanced adjustment journals, dispute handling, and approved driver transfer/settlement workflows. See [current status](18-implementation-status.md).
