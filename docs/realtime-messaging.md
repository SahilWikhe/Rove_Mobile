...
These checks do not establish background push delivery, unlimited scale, production activation or physical-device acceptance. Message retention/deletion policy remains separate from real-time transport.
