...
The deployed staging catalog currently has 47 application tables and 88 migrations through 0087. Derive expected tables and journal entries from the selected release commit when executing the drill; these numbers are not permanent acceptance constants.
