...
The duplicate Home & Work management card has been removed from booking. Use Ride shortcuts for saved destinations and Account → Saved places for management; failed shortcuts retain manual search and point to Account for corrections.
